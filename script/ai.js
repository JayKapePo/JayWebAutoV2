...
        return api.sendMessage('Please kindly provide an question \nExample: {pn}Ai what is love?\nDeveloper: www.facebook.com/JayCantFinddd', event.threadID, event.messageID);
